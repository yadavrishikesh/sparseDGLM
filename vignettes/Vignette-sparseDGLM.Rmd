...
Simulate spatial locations for 100 sites:

```{r simulate-locations, fig.width=8, fig.height=6}
nt <- 200
ns <- 100
set.seed(1)
...
```{r examine-data, fig.width=8, fig.height=8}
par(mfrow=c(2,2))
...
```{r mesh-hyperparameters, fig.width=5, fig.height=5}
...
### Estiamte of Spatiotemproal Intercepts
